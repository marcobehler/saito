...
public class LinkHelperTest {
    ...
    public void favIcon_jpg() {
        final String link = new LinkHelper(new Model(mock(SaitoConfig.class)), Paths.get(".")).favicon("test.jpg");
        assertThat(link).isEqualTo("<link rel=\"icon\" type=\"image/jpeg\" href=\"/images/test.jpg\"/>");
    }

    @Test
    public void favIcon_jpeg() {
        final String link = new LinkHelper(new Model(mock(SaitoConfig.class)), Paths.get(".")).favicon("test.jpeg");
    ...
    public void favIcon_correct_mimeType() {
        final String link = new LinkHelper(new Model(mock(SaitoConfig.class)), Paths.get(".")).favicon("test.png");
    ...
    @Test
    public void img_tag() {
        final String link = new LinkHelper(new Model(mock(SaitoConfig.class)), Paths.get(".")).imageTag("myImage.png", null, null, null, null, null);
        assertThat(link).isEqualTo("<img src=\"/images/myImage.png\" />");
    }

    @Test
    public void img_tag_with_height() {
        final String link = new LinkHelper(new Model(mock(SaitoConfig.class)), Paths.get(".")).imageTag("myImage.png", null, 30, null, null, null);
    ...
    public void img_tag_with_width() {
        final String link = new LinkHelper(new Model(mock(SaitoConfig.class)), Paths.get(".")).imageTag("myImage.png", 25, null, null, null, null);
        assertThat(link).isEqualTo("<img src=\"/images/myImage.png\" width=\"25\" />");
    }

    @Test
    public void img_tag_all_options() {
        final String link = new LinkHelper(new Model(mock(SaitoConfig.class)), Paths.get(".")).imageTag("myImage.png", 32, 64, "huhuCss", "customData", "customAlt");
