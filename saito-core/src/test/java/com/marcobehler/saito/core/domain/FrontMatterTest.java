...
public class FrontMatterTest {
    ...
    public void parse_frontMatter() {
        ...
        assertThat(frontMatter.get("current_page").get("blubb")).isEqualTo(true);
        assertThat(frontMatter.get("current_page").get("test")).isEqualTo("a");
    }
    ...
    public void parse_frontMatter_ignores_empty_frontmatter() {
        ...
        assertThat(frontMatter.get("current_page").size()).isEqualTo(0);
    }
